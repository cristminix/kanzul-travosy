  ...
  const router = createHashRouter(
    createRoutesFromElements(
      <Route path="" element={<ProdukApp />}>
        ...
        <Route path="penulis/:author/page/:pageNumber" element={<ProdukList byAuthor={true} loadingModel={loadingModel} model={mProdukRo} reload={reload}/>} loader={produkLoader} />
        <Route path="penulis/:author" element={<ProdukList byAuthor={true} loadingModel={loadingModel} model={mProdukRo} reload={reload}/>} loader={produkLoader} />
        <Route path="baca/:id/:slug" element={<ProdukDetail  model={mProdukRo} loadingModel={loadingModel} reload={reload}/>} loader={produkLoader} />
