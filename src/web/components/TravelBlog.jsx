 ...
 const TravelBlog = ({})=>{
    ...
    return <>
      <div className={cls0}> 
                 <div className={cls1}> 
                     <h3 className={cls2}> Travel Blogs </h3> 

                     <p className={cls3}> This is just a simple text made for this unique and awesome template, you can replace it with any text. </p> 
                 </div> {/*<!--end grid-->*/} 

                 <div className={cls4}> 
                     <div className={cls5}> 
                         <div className={cls6}> 
                             <img src="assets/images/blog/1.jpg" alt="" className={cls7}/> 
                             <div className={cls8}> 
                                 <span className={cls9}> Travel </span> 
                             </div> 
                         </div> 

                         <div className={cls10}> 
                             <div className={cls11}> 
                                 <span className={cls12}> <i data-feather="clock" className={cls13}> </i> 5 min read </span> 
                                 <span className={cls14}> by  <a href="" className={cls15}> Travosy </a> </span> 
                             </div> 

                             <a href="blog-detail.html" className={cls16}> This Spanish city is a feast for the eyes: Travosy </a> 
                             <p className={cls17}> This is required when, for example, the final text is not yet available. </p> 

                             <div className={cls18}> 
                                 <a href="blog-detail.html" className={cls19}> Read More  <i data-feather="chevron-right" className={cls20}> </i> </a> 
                             </div> 
                         </div> 
                     </div> {/*<!--end content-->*/} 
                     ...
                     <div className={cls5}> 
                         <div className={cls6}> 
                             <img src="assets/images/blog/2.jpg" alt="" className={cls7}/> 
                             <div className={cls8}> 
                                 <span className={cls9}> Tour </span> 
                             </div> 
                         </div> 
                         ...
                         <div className={cls10}> 
                             ...
                             <a href="blog-detail.html" className={cls16}> New Zealand&#x2019;s South Island brims with majestic </a> 
                             <p className={cls17}> This is required when, for example, the final text is not yet available. </p> 
                     ...
                     <div className={cls5}> 
                         <div className={cls6}> 
                             <img src="assets/images/blog/3.jpg" alt="" className={cls7}/> 
                             <div className={cls8}> 
                                 <span className={cls9}> Tourist </span> 
                             </div> 
                         </div> 
                         ...
                         <div className={cls10}> 
                             ...
                             <a href="blog-detail.html" className={cls16}> When you visit the Eternal Rome City: Travosy </a> 
                             <p className={cls17}> This is required when, for example, the final text is not yet available. </p> 
