 ...
 const BeritaBanner = ({ breadcrumbs, banner,berita }) => {
  ...
  useEffect(() => {
    ...
    const cls0 = "cls-0 relative table w-full items-center py-36  bg-top bg-no-repeat bg-cover"
		...
		const cls11 = "cls-11 inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white/50 hover:text-white"
         ...
         <section className={cls0} style={bgStyle}> 
             ...
             <div className={cls2}> 
                 <div className={cls3}> 
                     ...
                     <ul className={cls5}> 
                         <li className={cls6}>   <span className={cls7}> Penulis : </span>   <span className={cls8}> {berita.author} </span> </li> 
                         <li className={cls6}>   <span className={cls7}> Tanggal : </span>   <span className={cls8}> {berita.tanggal} </span> </li> 
                         <li className={cls6}>   <span className={cls7}> Waktu : </span>   <span className={cls8}> {berita.readingTime} Menit Baca </span> </li> 
                     </ul> 
                 </div> {/*<!--end grid-->*/} 
             </div> {/*<!--end container-->*/} 
