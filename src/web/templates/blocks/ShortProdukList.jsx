    ...
    return <>
      <div className={cls0}> 
                 ...
                 {produkList.map((post,index)=>{
                    const postUrl=`/produk/#/baca/${post.id}/${post.slug}`
                    return <div className={cls5} key={index}> 
                         ...
                         <div className={cls10}> 
                             <div className={cls11}> 
                                 ...
                                 <span className={cls14}> <IconUser className={`${cls21} ${cls13} `}/> <a href={`/produk/#/penulis/${post.author}`} className={cls15}> {post.author?`${post.author}`:'Admin'} </a> </span> 
                             </div> 
