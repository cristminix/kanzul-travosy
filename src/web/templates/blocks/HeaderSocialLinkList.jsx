...
const FooterSocialLinkList = ({ socialNetworkLinks }) => {
    ...
    const cls9 = "list-none"
    const cls10 = "inline-flex ms-2 mb-0"
    const cls11 = "text-slate-300 hover:text-red-500"
    const cls12 = "size-4 align-middle"
    return <ul className={cls9}>
        {fb && (<li className="inline-flex mb-0"> <a href={`${fb}`} target="_blank" className={cls11}> <i data-feather="facebook" title="facebook" className={cls12}> </i> </a> </li>)}
