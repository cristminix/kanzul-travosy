                      ...
                      <div className={cls10}>
                        <div className={cls11}>
                          ...
                          <span className={`${cls14} twx-flex twx-items-center`}>
                            ...
                            <a href={`/berita/#/penulis/${item.author}`} className={cls15}>
                              {item.author}
                            </a>
                          </span>
                        </div>
                        {
                          /*item.compiledHash*/ false ? (
                            <a href={`/berita/baca/${item.id}/${slug}`} className={cls16}>
                              {item.title}
                            </a>
                          ) : (
                            <Link to={`/baca/${item.id}/${slug}`} className={cls16}>
                              {item.title}
                            </Link>
                          )
                        }
                        ...
                        <div className={cls18}>
                          {
                            /*item.compiledHash*/ false ? (
                              <a href={`/berita/baca/${item.id}/${slug}`} className={cls19}>
                                Selengkapnya
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="24"
                              ...
                              <Link to={`/baca/${item.id}/${slug}`} className={cls19}>
                                Selengkapnya
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="24"
