      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
            ...
            <Collapse in={this.state.contentMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  {" "}
                  <Link
                    className={this.isPathActive("/contents/company") ? "nav-link active" : "nav-link"}
                    to="/contents/company">
                    <Trans>Company</Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  {" "}
                  <Link
                    className={this.isPathActive("/contents/homepage") ? "nav-link active" : "nav-link"}
                    to="/contents/homepage">
                ...
                <li className="nav-item">
                  {" "}
                  <Link
                    className={this.isPathActive("/contents/welcome-message") ? "nav-link active" : "nav-link"}
                    to="/contents/welcome-message">
          ...
          <li className={this.isPathActive("/general-pages") ? "nav-item active" : "nav-item"}>
            <div
              className={this.state.generalPagesMenuOpen ? "nav-link menu-expanded" : "nav-link"}
